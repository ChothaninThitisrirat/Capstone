    ...
    return (
        ...
        <>
            ...
            >
                ...
                {checkCardIdUse ?<div className=" text-red-500 text-xs text-right">ID Card already exist.</div>
                : <div></div>
                }
                ...
                {checkTelUse ?<div className=" text-red-500 text-xs text-right">Phone number already exist.</div>
                : <div></div>
                }
