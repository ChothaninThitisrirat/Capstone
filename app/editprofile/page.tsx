  ...
  return (
    <>
        ...
        <div className="h-max overflow-y-hidden">
          ...
          <div className="flex flex-col bg-dark3">
            <div className="flex flex-col justify-start pt-16 items-center w-full bg-dark2 h-full drop-shadow-2xl rounded-b-3xl text-white">
              <div
                ...
                />
                <div className="flex font-normal text-2xl mt-8 text-white xl:text-5xl">{session.user.username}</div>

                <div className="flex mt-10 text-xl mb-3 text-white">
                  คะแนนของฉัน
                </div>
                <Rating name="half-rating-read" value={user.review_avg} readOnly size="small" />
                
                <div className="flex text-ls mb-3 mt-2">
                  {user.review_avg} คะแนน ({user.review_count.reviewer_id})
                </div>
                <div 
                  className='flex justify-center items-center bg-white rounded-full text-dark2 mb-8 text-xs font-bold  w-3/6  h-10 cursor-pointer transform transition duration-500 ease-in-out hover:scale-10 xl:text-lg'
                  onClick={() => setStatePage(0)}>
                  อ่านรีวิวของฉัน
                </div>
            </div>

            <div className="w-full bg-dark3 h-full flex-col">
              <div className="flex flex-col justify-evenly items-center w-full min-h-36 py-6 gap-4 bg-dark3">
                <div className="flex flex-row min-w-28 text-white text-lg font-bold ">
                  {StatePage === 1 ?  <p 
                  ...
                  >
                    <Icon icon="iconamoon:profile" className='w-6 h-6 mr-3 lg:w-5 lg:h-5 xl:w-8 xl:h-8'/>
                    แก้ไขโปรไฟล์
                  </p> :
                  <p 
                ...
                {StatePage === 2 ?  <p 
                  ...
                  >
                    <Icon icon="material-symbols:local-shipping-outline" className='w-6 h-6 mr-3 lg:w-5 lg:h-5 xl:w-8 xl:h-8'/>
                    ข้อมูลการจัดส่ง
                  </p> :
                  <p 
                    className="flex w-full justify-center items-center cursor-pointer hover:drop-shadow-2xl transition-all hover:underline-offset-4  duration-300 ease-in-out hover:scale-105"
                ...
                {StatePage === 3 ?  <p 
                  ...
                  >
                    <Icon icon="tabler:social" className='w-6 h-6 mr-3 lg:w-5 lg:h-5 xl:w-8 xl:h-8'/>
                    ข้อมูลการติดต่อ
                  </p> :
                  <p 
                    className="flex w-full justify-center items-center cursor-pointer hover:drop-shadow-2xl transition-all hover:underline-offset-4  duration-300 ease-in-out hover:scale-105"
              ...
              <div className="flex w-full h-full bg-white items-center justify-center">
                {StatePage === 0 && 
                <div className="flex w-full h-full bg-white pt-4">
                    <div className="flex flex-col w-full gap-10 justify-center items-center px-3">
                        ...
                        {userReview?.length === 0
                          ...
                          {userReview.map((item, index) => (
                              ...
                              className="flex w-full h-60 rounded-3xl pt-5 px-5  shrink-0 duration-500 flex-col bg-white">
